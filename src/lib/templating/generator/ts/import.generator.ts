...
// import { TemplateStringGenerator } from "./TemplateStringGenerator";
...
> extends TemplateStringGenerator {
    ...
    constructor(name: Name, options?: { as?: As | undefined }) {
        super();
        this.as = options?.as;
        this.name = name;
    }
...
> extends TemplateStringGenerator {
    ...
    setAll<
        ...
        NewNamed extends NewGlobalAll extends false
            ? NamedImportGenerator
            : never,
    >(
        all: NewGlobalAll,
...
const importGenerator = ImportGenerator.create("DirectusSDK", {
    all: false,
    default: "DirectusSDK",
    named: [
        {
...
type e =
    typeof importGenerator extends ImportGenerator<
        infer From,
        infer All,
        infer Type,
        infer AllAs,
