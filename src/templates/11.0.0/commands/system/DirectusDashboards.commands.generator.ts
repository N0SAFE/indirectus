        ...
        FileGenerator.create([
            ...
            IdentifierGenerator.create(
                ...
                MultiLineGenerator.create([
                    defaultReadsFunction(collectionName, "readDashboards"),
                    defaultReadsVariable(collectionName),
                    defaultReadFunction(collectionName, "readDashboard"),
                    defaultReadVariable(collectionName),
                    defaultCreateFunction(collectionName, "createDashboard"),
                    defaultCreatesFunction(collectionName, "createDashboards"),
                    defaultUpdateFunction(collectionName, "updateDashboard"),
                    defaultUpdatesFunction(collectionName, "updateDashboards"),
                    defaultDeleteFunction(collectionName, "deleteDashboard"),
                    defaultDeletesFunction(collectionName, "deleteDashboards"),
