...
const collectionName = "DirectusOperations";
        ...
        FileGenerator.create([
            ...
            IdentifierGenerator.create(
                ...
                MultiLineGenerator.create([
                    defaultReadsFunction(collectionName, "readOperations"),
                    defaultReadsVariable(collectionName),
                    defaultReadFunction(collectionName, "readOperation"),
                    defaultReadVariable(collectionName),
                    defaultCreateFunction(collectionName, "createOperation"),
                    defaultCreatesFunction(collectionName, "createOperations"),
                    defaultUpdateFunction(collectionName, "updateOperation"),
                    defaultUpdatesFunction(collectionName, "updateOperations"),
                    defaultDeleteFunction(collectionName, "deleteOperation"),
                    defaultDeletesFunction(collectionName, "deleteOperations"),
