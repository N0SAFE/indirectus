        ...
        FileGenerator.create([
            ...
            IdentifierGenerator.create(
                ...
                MultiLineGenerator.create([
                    defaultReadsFunction(collectionName, "readTranslations"),
                    defaultReadsVariable(collectionName),
                    defaultReadFunction(collectionName, "readTranslation"),
                    defaultReadVariable(collectionName),
                    defaultCreateFunction(collectionName, "createTranslation"),
                    defaultCreatesFunction(
                        collectionName,
                        "createTranslations",
                    ),
                    defaultUpdateFunction(collectionName, "updateTranslation"),
                    defaultUpdatesFunction(
                        collectionName,
                        "updateTranslations",
                    ),
                    defaultDeleteFunction(collectionName, "deleteTranslation"),
                    defaultDeletesFunction(
                        collectionName,
                        "deleteTranslations",
                    ),
