        ...
        FileGenerator.create([
            ...
            IdentifierGenerator.create(
                ...
                MultiLineGenerator.create([
                    defaultReadsFunction(collectionName, "readPermissions"),
                    defaultReadsVariable(collectionName),
                    defaultReadFunction(collectionName, "readPermission"),
                    defaultReadVariable(collectionName),
                    defaultCreateFunction(collectionName, "createPermission"),
                    defaultCreatesFunction(collectionName, "createPermissions"),
                    defaultUpdateFunction(collectionName, "updatePermission"),
                    defaultUpdatesFunction(collectionName, "updatePermissions"),
                    defaultDeleteFunction(collectionName, "deletePermission"),
                    defaultDeletesFunction(collectionName, "deletePermissions"),
