...
const collectionName = "DirectusWebhooks";
        ...
        FileGenerator.create([
            ...
            IdentifierGenerator.create(
                ...
                MultiLineGenerator.create([
                    defaultReadsFunction(collectionName, "readWebhooks"),
                    defaultReadsVariable(collectionName),
                    defaultReadFunction(collectionName, "readWebhook"),
                    defaultReadVariable(collectionName),
                    defaultCreateFunction(collectionName, "createWebhook"),
                    defaultCreatesFunction(collectionName, "createWebhooks"),
                    defaultUpdateFunction(collectionName, "updateWebhook"),
                    defaultUpdatesFunction(collectionName, "updateWebhooks"),
                    defaultDeleteFunction(collectionName, "deleteWebhook"),
                    defaultDeletesFunction(collectionName, "deleteWebhooks"),
