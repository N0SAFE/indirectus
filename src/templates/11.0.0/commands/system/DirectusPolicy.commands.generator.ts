...
const collectionName = "DirectusPolicy";
        ...
        FileGenerator.create([
            ...
            IdentifierGenerator.create(
                ...
                MultiLineGenerator.create([
                    // defaultReadsFunction(collectionName, "readPolicys"),
                    // defaultReadsVariable(collectionName),
                    // defaultReadFunction(collectionName, "readPolicy"),
                    // defaultReadVariable(collectionName),
                    // defaultCreateFunction(collectionName, "createPolicy"),
                    // defaultCreatesFunction(collectionName, "createPolicys"),
                    // defaultUpdateFunction(collectionName, "updatePolicy"),
                    // defaultUpdatesFunction(collectionName, "updatePolicys"),
                    // defaultDeleteFunction(collectionName, "deletePolicy"),
                    // defaultDeletesFunction(collectionName, "deletePolicys"), // all off this method only exist after the sdk v11
