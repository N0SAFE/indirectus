        ...
        FileGenerator.create([
            ...
            IdentifierGenerator.create(
                ...
                MultiLineGenerator.create([
                    defaultReadsFunction(collectionName, "readFolders"),
                    defaultReadsVariable(collectionName),
                    defaultReadFunction(collectionName, "readFolder"),
                    defaultReadVariable(collectionName),
                    defaultCreateFunction(collectionName, "createFolder"),
                    defaultCreatesFunction(collectionName, "createFolders"),
                    defaultUpdateFunction(collectionName, "updateFolder"),
                    defaultUpdatesFunction(collectionName, "updateFolders"),
                    defaultDeleteFunction(collectionName, "deleteFolder"),
                    defaultDeletesFunction(collectionName, "deleteFolders"),
