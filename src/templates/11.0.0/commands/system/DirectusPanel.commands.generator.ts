        ...
        FileGenerator.create([
            ...
            IdentifierGenerator.create(
                ...
                MultiLineGenerator.create([
                    defaultReadsFunction(collectionName, "readPanels"),
                    defaultReadsVariable(collectionName),
                    defaultReadFunction(collectionName, "readPanel"),
                    defaultReadVariable(collectionName),
                    defaultCreateFunction(collectionName, "createPanel"),
                    defaultCreatesFunction(collectionName, "createPanels"),
                    defaultUpdateFunction(collectionName, "updatePanel"),
                    defaultUpdatesFunction(collectionName, "updatePanels"),
                    defaultDeleteFunction(collectionName, "deletePanel"),
                    defaultDeletesFunction(collectionName, "deletePanels"),
