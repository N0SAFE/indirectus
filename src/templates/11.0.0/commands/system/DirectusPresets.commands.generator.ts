...
const collectionName = "DirectusPresets";
        ...
        FileGenerator.create([
            ...
            IdentifierGenerator.create(
                ...
                MultiLineGenerator.create([
                    defaultReadsFunction(collectionName, "readPresets"),
                    defaultReadsVariable(collectionName),
                    defaultReadFunction(collectionName, "readPreset"),
                    defaultReadVariable(collectionName),
                    defaultCreateFunction(collectionName, "createPreset"),
                    defaultCreatesFunction(collectionName, "createPresets"),
                    defaultUpdateFunction(collectionName, "updatePreset"),
                    defaultUpdatesFunction(collectionName, "updatePresets"),
                    defaultDeleteFunction(collectionName, "deletePreset"),
                    defaultDeletesFunction(collectionName, "deletePresets"),
