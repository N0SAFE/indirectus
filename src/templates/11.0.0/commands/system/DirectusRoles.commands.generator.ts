...
const collectionName = "DirectusRoles";
        ...
        FileGenerator.create([
            ...
            IdentifierGenerator.create(
                ...
                MultiLineGenerator.create([
                    defaultReadsFunction(collectionName, "readRoles"),
                    defaultReadsVariable(collectionName),
                    defaultReadFunction(collectionName, "readRole"),
                    defaultReadVariable(collectionName),
                    defaultCreateFunction(collectionName, "createRole"),
                    defaultCreatesFunction(collectionName, "createRoles"),
                    defaultUpdateFunction(collectionName, "updateRole"),
                    defaultUpdatesFunction(collectionName, "updateRoles"),
                    defaultDeleteFunction(collectionName, "deleteRole"),
                    defaultDeletesFunction(collectionName, "deleteRoles"),
